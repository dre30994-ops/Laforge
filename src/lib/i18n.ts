...
const en = {
  ...
  theme: {
    toNight: "Switch to black and gold",
    toDay: "Switch back to light",
  },
  chain: {
  ...
  dash: {
    ...
    step2: "Stake",
    step2d: "Lock tokens in a pool.",
    step3: "Stay",
    step3d: "Time in the pool raises your rate.",
    step4: "Claim",
    step4d: "Take emissions and holder payouts.",
    step5: "Refer",
    step5d: "Earn SOL + ETH based on referrals.",
    tenureKicker: "Tenure",
    tenureBody: "Stay in and the rate climbs, up to 2×. Unstake resets it.",
  },
  connect: {
...
const zh = {
  ...
  dash: {
    ...
    step4d: "领取排放和持仓奖励。",
    step5: "推荐",
    step5d: "按推荐赚取 SOL 和 ETH。",
    tenureKicker: "持有加成",
    tenureBody: "留下后倍率升高，最高 2×。解押会重置。",
  },
  connect: {
    withX: "使用 X 连接",
    connecting: "连接中…",
...
const hi = {
  ...
  theme: {
    toNight: "काले और सोने पर जाएँ",
    toDay: "हल्के रंग पर लौटें",
  },
  chain: {
  ...
  dash: {
    ...
    step2: "स्टेक",
    step2d: "टोकन पूल में लॉक करो।",
    step3: "रुको",
    step3d: "जितना लंबा स्टेक, रेट उतना ऊपर।",
    step4: "क्लेम",
    step4d: "एमिशन और होल्डर पेआउट लो।",
    step5: "रेफ़र",
    step5d: "रेफ़रल पर SOL और ETH कमाओ।",
    tenureKicker: "टेन्योर",
    tenureBody: "अंदर रहो तो रेट 2× तक चढ़ता है। अनस्टेक से रीसेट।",
  },
  connect: {
